...
class SerialCommunicationApp:
    ...
    def process_reset_device(self):
        ...
        self.result_factory_mode_label.config(text="Not Yet")
        self.result_read_device_mac.config(text="Not Yet")
        self.result_write_serialnumber.config(text="Not Yet")
        self.result_write_mtqr.config(text="Not Yet")
        self.result_3_3v_test.config(text="Not Yet")
        self.result_5v_test.config(text="Not Yet")
        self.result_temp_label.config(text="Not Yet")
        self.result_humid_label.config(text="Not Yet")
        self.result_rgb_red_label.config(text="Not Yet")
        self.yes_button_red.config(state='normal')
        self.no_button_red.config(state='normal')
        self.result_rgb_green_label.config(text="Not Yet")
        self.yes_button_green.config(state='normal')
        self.no_button_green.config(state='normal')
        self.result_rgb_blue_label.config(text="Not Yet")
