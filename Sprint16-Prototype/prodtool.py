...
#     # Fix cant find dmm.py and dmm_output.txt
#     def exec_dmm(self):
#         script = None
#         output_file = None

#         # Search for dmm.py
#         for file in glob.glob("**/dmm.py", recursive=True):
#             script = file
#             break  # Stop searching after finding the first occurrence

#         # Search for dmm_output.txt
#         for file in glob.glob("**/dmm_output.txt", recursive=True):
#             output_file = file
#             break  # Stop searching after finding the first occurrence

#         if script is None or output_file is None:
#             print("Error: Files not found.")
#         else:
#             print("dmm.py found at:", script)
#             print("dmm_output.txt found at:", output_file)
...
#         self.dmm_button_1 = tk.Button(self.serial_baud_frame, text="MultiMeter1", command=None)
#         self.dmm_button_1.grid(row=0, column=7, padx=5, pady=5, sticky=tk.W)    
        
#         self.dmm_button_2 = tk.Button(self.serial_baud_frame, text="MultiMeter2", command=None)
...
#         # self.dmm_button.grid(row=0, column=8, padx=5, pady=5, sticky=tk.W)
...
#         self.create_buttons_from_config(self.load_config("manual_test.ini"), manual_test_frame)
